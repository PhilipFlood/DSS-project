...
public class main {
	...
	public static void main(String[] args) {
		try {
			...
			//main funct
			File file = new File("iTunes Music Library3.xml");  
			...
			for(int i = 0;i<list.size();i++){
				...
				Playlist newplaylist = new Playlist(playlistID, name, ptrackIds);
			...
			System.out.println("");
			System.out.println("********");
			System.out.println("arraylist of playlists by name");
